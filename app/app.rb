...
get '/' do
  @nodes = Node.reporting_nodes.to_a
  ...
  @last_hour_unreporting = Node.unreporting_nodes(2.hours.ago, 1.hour.ago)
  @last_six_unreporting = Node.unreporting_nodes(6.hours.ago, 2.hours.ago)
  @last_day_unreporting = Node.unreporting_nodes(1.day.ago, 6.hours.ago)
